      ...
      for(unsigned int i=0;i<m_vVDcyBrP.size();i++)
        {
          ...
          for(unsigned int j=0;j<nDcyBrPToBePrtd;j++)
            {
              ...
              fout<<"rowNo:  "<<j+1<<"\tiDcyBrP:  "<<m_vVIDcyBrP[i][j]<<"\tnCases:  "<<m_vVNDcyBrP[i][j];
              if(m_ccSwitch==true)
                {
                  fout<<"\tnCcCases:  ";
          ...
          if(nDcyBrPToBePrtd<m_vVDcyBrP[i].size())
            {
              fout<<"rowNo:  rest\tiDcyBrP:  ---\tnCases:  ";
      ...
      for(unsigned int i=0;i<m_vVProdBrP.size();i++)
        {
          ...
          for(unsigned int j=0;j<nProdBrPToBePrtd;j++)
            {
              ...
              fout<<"rowNo:  "<<j+1<<"\tiProdBrP:  "<<m_vVIProdBrP[i][j]<<"\tnCases:  "<<m_vVNProdBrP[i][j];
              if(m_ccSwitch==true)
                {
                  fout<<"\tnCcCases:  ";
          ...
          if(nProdBrPToBePrtd<m_vVProdBrP[i].size())
            {
              fout<<"rowNo:  rest\tiProdBrP:  ---\tnCases:  ";
              unsigned long nCCasesOfRest=0;
              if(m_ccSwitch==true)
                {
      ...
      for(unsigned int i=0;i<m_vVMpidP.size();i++)
        {
          ...
          for(unsigned int j=0;j<nMPToBePrtd;j++)
            {
              ...
              fout<<"\tMothPDG:  "<<m_vVMpidP[i][j]<<"\tnCases:  "<<m_vVNMP[i][j];
              if(m_ccSwitch==true)
                {
                  fout<<"\tnCcCases:  ";
          ...
          if(nMPToBePrtd<m_vVMpidP[i].size())
            {
              fout<<"rowNo:  rest\tMother:  others\tMothPDG:  Corresponding to others\tnCases:  ";
              unsigned long nCCasesOfRest=0;
              if(m_ccSwitch==true)
                {
                  if(m_vICcCompMP[i]==0)
      ...
      for(unsigned int i=0;i<m_vVDcyBrIncDcyBr.size();i++)
        {
          ...
          for(unsigned int j=0;j<nDcyBrIncDcyBrToBePrtd;j++)
            {
              ...
              fout<<"rowNo:  "<<j+1<<"\tiDcyBrIncDcyBr:  "<<m_vVIDcyBrIncDcyBr[i][j]<<"\tnCases:  "<<m_vVNDcyBrIncDcyBr[i][j];
              if(m_ccSwitch==true)
                {
                  fout<<"\tnCcCases:  ";
          ...
          if(nDcyBrIncDcyBrToBePrtd<m_vVDcyBrIncDcyBr[i].size())
            {
              fout<<"rowNo:  rest\tiDcyBrIncDcyBr:  ---\tnCases:  ";
              unsigned long nCCasesOfRest=0;
              if(m_ccSwitch==true)
                {
      ...
      for(unsigned int i=0;i<m_vVDcyBrIRADcyBr.size();i++)
        {
          ...
          for(unsigned int j=0;j<nDcyBrIRADcyBrToBePrtd;j++)
            {
              ...
              fout<<"rowNo:  "<<j+1<<"\tiDcyBrIRADcyBr:  "<<m_vVIDcyBrIRADcyBr[i][j]<<"\tnCases:  "<<m_vVNDcyBrIRADcyBr[i][j];
              if(m_ccSwitch==true)
                {
                  fout<<"\tnCcCases:  ";
          ...
          if(nDcyBrIRADcyBrToBePrtd<m_vVDcyBrIRADcyBr[i].size())
            {
              fout<<"rowNo:  rest\tiDcyBrIRADcyBr:  ---\tnCases:  ";
              unsigned long nCCasesOfRest=0;
              if(m_ccSwitch==true)
                {
