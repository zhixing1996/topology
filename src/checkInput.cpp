...
void topoana::checkInput()
{
      ...
      for(unsigned int i=0;i<m_vPid_compDcyBrP.size();i++)
        {
          ...
          if(m_vNm_compDcyBrP[i]!="")
          ...
          else
            {
              ...
              cout<<"  Alias for the particle is set to be \""<<nm_compDcyBrP<<"\" for the branch names of the topology tags (default)"<<endl<<endl;
      ...
      for(unsigned int i=0;i<m_vPid_compProdBrP.size();i++)
        {
          ...
          if(m_vNm_compProdBrP[i]!="")
          ...
          else
            {
              ...
              cout<<"  Alias for the particle is set to be \""<<nm_compProdBrP<<"\" for the branch names of the topology tags (default)"<<endl<<endl;
      ...
      for(unsigned int i=0;i<m_vPid_compMP.size();i++)
        {
          ...
          if(m_vNm_compMP[i]!="")
          ...
          else
            {
              ...
              cout<<"  Alias for the particle is set to be \""<<nm_compMP<<"\" for the branch names of the topology tags (default)"<<endl<<endl;
          ...
          for(unsigned int j=0;j<m_vVPid_compIncDcyBr[i].size();j++)
	    {
          ...
          if(m_vNm_compIncDcyBr[i]!="")
          ...
          else
            {
              ...
              cout<<"  Alias for the inclusive decay branch is set to be \""<<nm_compIncDcyBr<<"\" for the branch names of the topology tags (default)"<<endl<<endl;
            }
        }
      cout<<endl;
          ...
          for(unsigned int j=0;j<m_vVPid_compIRADcyBr[i].size();j++)
	    {
          ...
          if(m_vNm_compIRADcyBr[i]!="")
          ...
          else
            {
              ...
              cout<<"  Alias for the intermediate-resonance-allowed decay branch is set to be \""<<nm_compIRADcyBr<<"\" for the branch names of the topology tags (default)"<<endl<<endl;
            }
        }
      cout<<endl;
  ...
  if(m_vVPid_sigDcyTr.size()==0)
      ...
      for(unsigned int i=0;i<m_vVPid_sigDcyTr.size();i++)
	{
          for(unsigned int j=0;j<m_vVPid_sigDcyTr[i].size();j++)
	    {
          ...
          if(m_vNm_sigDcyTr[i]!="")
            {
              cout<<"  Alias for the signal decay tree is set to be \""<<m_vNm_sigDcyTr[i]<<"\" for the branch value of the topology tag \"nameSigDcyTr\""<<endl<<endl;
            }
          else
            {
              sprintf(nm_sigDcyTr, "%d", i);
              cout<<"  Alias for the signal decay tree is set to be \""<<nm_sigDcyTr<<"\" for the branch value of the topology tag \"nameSigDcyTr\" (default)"<<endl<<endl;
            }
	}
      cout<<endl;
          ...
          if(iSigDcyIFSts==-1)
            {
              ...
              if(m_ccSwitch==true)
                {
                  ccSigDcyIFSts.clear();
                  getDcyIFSts(vPid_ccSigDcyTr,vMidx_ccSigDcyTr,ccSigDcyIFSts);
      ...
      for(unsigned int i=0;i<m_vVPid_sigDcyIFSts2.size();i++)
	{
          for(unsigned int j=0;j<m_vVPid_sigDcyIFSts2[i].size();j++)
	    {
          ...
          if(m_vNm_sigDcyIFSts2[i]!="")
            {
              cout<<"  Alias for the signal decay initial-final states is set to be \""<<m_vNm_sigDcyIFSts2[i]<<"\" for the branch value of the topology tag \"nameSigDcyIFSts2\""<<endl<<endl;
            }
          else
            {
              sprintf(nm_sigDcyIFSts2, "%d", i);
              cout<<"  Alias for the signal decay initial-final states is set to be \""<<nm_sigDcyIFSts2<<"\" for the branch value of the topology tag \"nameSigDcyIFSts2\" (default)"<<endl<<endl;
            }
	}
      cout<<endl;
      ...
      for(unsigned int i=0;i<m_vSigDcyIFSts2.size();i++)
        {
          ...
          if(m_vNm_sigDcyIFSts2[i]!="")
            ...
            { 
              sprintf(nm_sigDcyIFSts2, "%d", i);
              cout<<"  Alias for the signal decay initial-final states is set to be \""<<nm_sigDcyIFSts2<<"\" for the branch value of the topology tag \"nameSigDcyIFSts2\" (default)"<<endl<<endl;
              m_vNm_sigDcyIFSts2[i]=nm_sigDcyIFSts2;
            }
        }
      ...
      for(unsigned int i=0;i<m_vPid_sigP.size();i++)
        {
          ...
          if(m_vNm_sigP[i]!="")
            ...
            {
              sprintf(nm_sigP, "%d", i);
              cout<<"  Alias for the signal particle is set to be \""<<nm_sigP<<"\" for the branch names of the topology tags (default)"<<endl<<endl;
          ...
          for(unsigned int j=0;j<m_vVPid_sigDcyBr[i].size();j++)
	    {
          ...
          if(m_vNm_sigDcyBr[i]!="")
          ...
          else
            {
              ...
              cout<<"  Alias for the signal decay branch is set to be \""<<nm_sigDcyBr<<"\" for the branch names of the topology tags (default)"<<endl<<endl;
            }
	}
      cout<<endl;
          ...
          for(unsigned int j=0;j<m_vVPid_sigIncDcyBr[i].size();j++)
	    {
          ...
          if(m_vNm_sigIncDcyBr[i]!="")
          ...
          else
            {
              ...
              cout<<"  Alias for the signal inclusive decay branch is set to be \""<<nm_sigIncDcyBr<<"\" for the branch names of the topology tags (default)"<<endl<<endl;
            }
	}
      cout<<endl;
      ...
      for(unsigned int i=0;i<m_vVPid_sigCascDcyBrs.size();i++)
	{
          for(unsigned int j=0;j<m_vVPid_sigCascDcyBrs[i].size();j++)
	    {
          ...
          if(m_vNm_sigCascDcyBrs[i]!="")
            {
              cout<<"  Alias for the signal cascade decay branches are set to be \""<<m_vNm_sigCascDcyBrs[i]<<"\" for the branch names of the topology tags"<<endl<<endl;
            }
          else
            {
              sprintf(nm_sigCascDcyBrs, "%d", i);
              cout<<"  Alias for the signal cascade decay branches are set to be \""<<nm_sigCascDcyBrs<<"\" for the branch names of the topology tags (default)"<<endl<<endl;
            }
	}
      cout<<endl;
      ...
      vector<int> vPid_ccSigCascDcyBrs, vMidx_ccSigCascDcyBrs;
      for(unsigned int i=0;i<m_vVPid_sigCascDcyBrs.size();i++)
        {
          ...
          if(m_ccSwitch==true)
            {
              vPid_ccSigCascDcyBrs.clear();
              vMidx_ccSigCascDcyBrs.clear();
              for(unsigned int j=0;j<m_vVPid_sigCascDcyBrs[i].size();j++) vPid_ccSigCascDcyBrs.push_back(getCcPid(m_vVPid_sigCascDcyBrs[i][j])); 
              vMidx_ccSigCascDcyBrs=m_vVMidx_sigCascDcyBrs[i];
              sortPs(vPid_ccSigCascDcyBrs,vMidx_ccSigCascDcyBrs);
              ccSigCascDcyBrs.clear();
              vCcSigCascDcyBrsIdxOfHead.clear();
              vCcSigCascDcyBrsMidxOfHead.clear();
              getDcyTr(vPid_ccSigCascDcyBrs,vMidx_ccSigCascDcyBrs,ccSigCascDcyBrs,&vCcSigCascDcyBrsIdxOfHead,&vCcSigCascDcyBrsMidxOfHead);
        ...
        { 
          ...
          if(m_vNm_sigCascDcyBrs[i]!="")
          ...
          else
            {
              sprintf(nm_sigCascDcyBrs, "%d", i);
              cout<<"  Alias for the signal cascade decay branches are set to be \""<<nm_sigCascDcyBrs<<"\" for the branch names of the topology tags (default)"<<endl<<endl;
              m_vNm_sigCascDcyBrs[i]=nm_sigCascDcyBrs;
            }
        }
    }
      ...
      for(unsigned int i=0;i<m_vVPid_sigIncCascDcyBrs.size();i++)
	{
          for(unsigned int j=0;j<m_vVPid_sigIncCascDcyBrs[i].size();j++)
	    {
          ...
          if(m_vNm_sigIncCascDcyBrs[i]!="")
            {
              cout<<"  Alias for the signal inclusive cascade decay branches are set to be \""<<m_vNm_sigIncCascDcyBrs[i]<<"\" for the branch names of the topology tags"<<endl<<endl;
            }
          else
            {
              sprintf(nm_sigIncCascDcyBrs, "%d", i);
              cout<<"  Alias for the signal inclusive cascade decay branches are set to be \""<<nm_sigIncCascDcyBrs<<"\" for the branch names of the topology tags (default)"<<endl<<endl;
            }
	}
      cout<<endl;
      ...
      vector<int> vPid_ccSigIncCascDcyBrs, vMidx_ccSigIncCascDcyBrs;
      for(unsigned int i=0;i<m_vVPid_sigIncCascDcyBrs.size();i++)
        {
          ...
          if(m_ccSwitch==true)
            {
              vPid_ccSigIncCascDcyBrs.clear();
              vMidx_ccSigIncCascDcyBrs.clear();
              for(unsigned int j=0;j<m_vVPid_sigIncCascDcyBrs[i].size();j++) vPid_ccSigIncCascDcyBrs.push_back(getCcPid(m_vVPid_sigIncCascDcyBrs[i][j])); 
              vMidx_ccSigIncCascDcyBrs=m_vVMidx_sigIncCascDcyBrs[i];
              sortPs(vPid_ccSigIncCascDcyBrs,vMidx_ccSigIncCascDcyBrs);
              ccSigIncCascDcyBrs.clear();
              vCcSigIncCascDcyBrsIdxOfHead.clear();
              vCcSigIncCascDcyBrsMidxOfHead.clear();
              getDcyTr(vPid_ccSigIncCascDcyBrs,vMidx_ccSigIncCascDcyBrs,ccSigIncCascDcyBrs,&vCcSigIncCascDcyBrsIdxOfHead,&vCcSigIncCascDcyBrsMidxOfHead);
        ...
        { 
          ...
          if(m_vNm_sigIncCascDcyBrs[i]!="")
          ...
          else
            {
              sprintf(nm_sigIncCascDcyBrs, "%d", i);
              cout<<"  Alias for the signal inclusive cascade decay branches are set to be \""<<nm_sigIncCascDcyBrs<<"\" for the branch names of the topology tags (default)"<<endl<<endl;
              m_vNm_sigIncCascDcyBrs[i]=nm_sigIncCascDcyBrs;
            }
        }
    }
          ...
          for(unsigned int j=0;j<m_vVPid_sigIRADcyBr[i].size();j++)
	    {
          ...
          if(m_vNm_sigIRADcyBr[i]!="")
          ...
          else
            {
              ...
              cout<<"  Alias for the signal intermediate-resonance-allowed decay branch is set to be \""<<nm_sigIRADcyBr<<"\" for the branch names of the topology tags (default)"<<endl<<endl;
            }
	}
      cout<<endl;
  ...
  if(m_vVPid_sigIncOrIRACascDcyBrs.size()==0)
  ...
  else
    {
      ...
      char nm_sigIncOrIRACascDcyBrs[20];
      for(unsigned int i=0;i<m_vVPid_sigIncOrIRACascDcyBrs.size();i++)
	{
          for(unsigned int j=0;j<m_vVPid_sigIncOrIRACascDcyBrs[i].size();j++)
	    {
          ...
          if(m_vNm_sigIncOrIRACascDcyBrs[i]!="")
            {
              cout<<"  Alias for the signal inclusive or intermediate-resonance-allowed cascade decay branches are set to be \""<<m_vNm_sigIncOrIRACascDcyBrs[i]<<"\" for the branch names of the topology tags"<<endl<<endl;
            }
          else
            {
              sprintf(nm_sigIncOrIRACascDcyBrs, "%d", i);
              cout<<"  Alias for the signal inclusive or intermediate-resonance-allowed cascade decay branches are set to be \""<<nm_sigIncOrIRACascDcyBrs<<"\" for the branch names of the topology tags (default)"<<endl<<endl;
            }
	}
      cout<<endl;
      ...
      vector<int> vPid_ccSigIncOrIRACascDcyBrs, vMidx_ccSigIncOrIRACascDcyBrs;
      for(unsigned int i=0;i<m_vVPid_sigIncOrIRACascDcyBrs.size();i++)
        {
          ...
          if(m_ccSwitch==true)
            {
              vPid_ccSigIncOrIRACascDcyBrs.clear();
              vMidx_ccSigIncOrIRACascDcyBrs.clear();
              for(unsigned int j=0;j<m_vVPid_sigIncOrIRACascDcyBrs[i].size();j++) vPid_ccSigIncOrIRACascDcyBrs.push_back(getCcPid(m_vVPid_sigIncOrIRACascDcyBrs[i][j])); 
              vMidx_ccSigIncOrIRACascDcyBrs=m_vVMidx_sigIncOrIRACascDcyBrs[i];
              sortPs(vPid_ccSigIncOrIRACascDcyBrs,vMidx_ccSigIncOrIRACascDcyBrs);
              ccSigIncOrIRACascDcyBrs.clear();
              vCcSigIncOrIRACascDcyBrsIdxOfHead.clear();
              vCcSigIncOrIRACascDcyBrsMidxOfHead.clear();
              getDcyTr(vPid_ccSigIncOrIRACascDcyBrs,vMidx_ccSigIncOrIRACascDcyBrs,ccSigIncOrIRACascDcyBrs,&vCcSigIncOrIRACascDcyBrsIdxOfHead,&vCcSigIncOrIRACascDcyBrsMidxOfHead);
        ...
        { 
          ...
          if(m_vNm_sigIncOrIRACascDcyBrs[i]!="")
          ...
          else
            {
              sprintf(nm_sigIncOrIRACascDcyBrs, "%d", i);
              cout<<"  Alias for the signal inclusive or intermediate-resonance-allowed cascade decay branches are  set to be \""<<nm_sigIncOrIRACascDcyBrs<<"\" for the branch names of the topology tags (default)"<<endl<<endl;
              m_vNm_sigIncOrIRACascDcyBrs[i]=nm_sigIncOrIRACascDcyBrs;
            }
        }
    }
  ...
  if(m_rmIptBrs==true)
    {
      cout<<"The input branches will be removed from the output root files."<<endl<<endl;
    }
  else
    {
      cout<<"The input branches will not be removed from the output root files (default)."<<endl<<endl;
    }
}
