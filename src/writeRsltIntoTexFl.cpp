...
void topoana::writeRsltIntoTexFl()
{
  ...
  fout<<"\\newcommand{\\cmtTopoTags}[1]{#1}"<<endl;
  fout<<"%\\newcommand{\\cmtTopoTags}[1]{}"<<endl;
      ...
      for(unsigned long i=0;i<nDcyTrsToBePrtd;i++)
        {
          if(i==0)
            {
              ...
              fout<<" & \\cmtTopoTags{iDcyTr & iDcyIFSts & }nEtrs & ";
          ...
          fout<<"\\cmtTopoTags{"<<m_vIDcyTr[i]<<" & "<<m_iDcyTrIDcyIFStsMap[m_vIDcyTr[i]]<<" & }"<<m_vNDcyTr[i]<<" & ";
          if(m_ccSwitch==true)
            {
      ...
      for(unsigned long i=0;i<nDcyIFStsToBePrtd;i++)
        {
          if(i==0)
            {
              ...
              fout<<"\\tableheader{rowNo & \\thead{decay initial-final states} & \\cmtTopoTags{iDcyIFSts & }nEtrs & ";
              if(m_ccSwitch==true) fout<<"nCcEtrs & nTotEtrs & ";
              fout<<"nCEtrs \\\\}"<<endl<<endl;
            }
          fout<<"% \\rn = "<<i+1<<endl;
          ...
          fout<<"\\rightarrow ";
          for(liit++;liit!=dcyIFSts.end();liit++) writePnmFromPid(fout,"TexPnm",(*liit));
          fout<<"$ & \\cmtTopoTags{"<<m_vIDcyIFSts[i]<<" & }"<<m_vNDcyIFSts[i]<<" & ";
          if(m_ccSwitch==true)
            {
              ...
              if(nDcyIFStsToBePrtd<m_vDcyIFSts.size())
                {
                  ...
                  fout<<"\\rightarrow \\rm{others} $ & \\cmtTopoTags{--- & }";
                  unsigned long nCEtrsOfRest=0;
                  if(m_ccSwitch==true)
                    {
                      fout<<"--- & --- & ";
          ...
          for(unsigned int j=0;j<nDcyBrPToBePrtd;j++)
            {
              if(j==0)
                {
                  ...
                  writePnmFromPid(fout,"TexPnm",m_vPid_compDcyBrP[i]);
                  fout<<"$} & \\cmtTopoTags{iDcyBrP & }nCases & ";
              ...
              fout<<"$ & \\cmtTopoTags{"<<m_vVIDcyBrP[i][j]<<" & }"<<m_vVNDcyBrP[i][j]<<" & ";
              if(m_ccSwitch==true)
                {
          ...
          for(unsigned int j=0;j<nProdBrPToBePrtd;j++)
            {
              if(j==0)
                {
                  ...
                  writePnmFromPid(fout,"TexPnm",m_vPid_compProdBrP[i]);
                  fout<<"$} & \\cmtTopoTags{iProdBrP & }nCases & ";
                  if(m_ccSwitch==true) fout<<"nCcCases & nTotCases & ";
                  fout<<"nCCases \\\\}"<<endl<<endl;
                }
              fout<<"% \\rn = "<<j+1<<endl;
              ...
              fout<<"$ & \\cmtTopoTags{"<<m_vVIProdBrP[i][j]<<" & }"<<m_vVNProdBrP[i][j]<<" & ";
              if(m_ccSwitch==true)
                {
          ...
          for(unsigned int j=0;j<nMPToBePrtd;j++)
            {
              if(j==0)
                {
                  ...
                  writePnmFromPid(fout,"TexPnm",m_vPid_compMP[i]);
                  fout<<"$} & \\cmtTopoTags{MothPDG & }nCases & ";
                  if(m_ccSwitch==true) fout<<"nCcCases & nTotCases & ";
                  fout<<"nCCases \\\\}"<<endl<<endl;
                }
              fout<<"% \\rn = "<<j+1<<endl;
              ...
              fout<<"$ & \\cmtTopoTags{"<<m_vVMpidP[i][j]<<" & }"<<m_vVNMP[i][j]<<" & ";
              if(m_ccSwitch==true)
                {
          ...
          for(unsigned int j=0;j<nDcyBrIncDcyBrToBePrtd;j++)
            {
              if(j==0)
                {
                  ...
                  fout<<"\\rightarrow ";
                  for(liit++;liit!=m_vCompIncDcyBr[i].end();liit++) writePnmFromPid(fout,"TexPnm",(*liit));
                  fout<<"+ \\rm{anything} $} & \\cmtTopoTags{iDcyBrIncDcyBr & }nCases & ";
                  if(m_ccSwitch==true) fout<<"nCcCases & nTotCases & ";
                  fout<<"nCCases \\\\}"<<endl<<endl;
                }
              fout<<"% \\rn = "<<j+1<<endl;
              ...
              fout<<"$ & \\cmtTopoTags{"<<m_vVIDcyBrIncDcyBr[i][j]<<" & }"<<m_vVNDcyBrIncDcyBr[i][j]<<" & ";
              if(m_ccSwitch==true)
                {
          ...
          for(unsigned int j=0;j<nDcyBrIRADcyBrToBePrtd;j++)
            {
              if(j==0)
                {
                  ...
                  fout<<"\\dashrightarrow ";
                  for(liit++;liit!=m_vCompIRADcyBr[i].end();liit++) writePnmFromPid(fout,"TexPnm",(*liit));
                  fout<<"$} & \\cmtTopoTags{iDcyBrIRADcyBr & }nCases & ";
                  if(m_ccSwitch==true) fout<<"nCcCases & nTotCases & ";
                  fout<<"nCCases \\\\}"<<endl<<endl;
                }
              fout<<"% \\rn = "<<j+1<<endl;
              ...
              fout<<"$ & \\cmtTopoTags{"<<m_vVIDcyBrIRADcyBr[i][j]<<" & }"<<m_vVNDcyBrIRADcyBr[i][j]<<" & ";
              if(m_ccSwitch==true)
                {
                  ...
                  if(nDcyBrIRADcyBrToBePrtd<m_vVDcyBrIRADcyBr[i].size())
                    {
                      ...
                      fout<<"\\rightarrow \\rm{others} \\rightarrow ";
                      for(liit++;liit!=m_vCompIRADcyBr[i].end();liit++) writePnmFromPid(fout,"TexPnm",(*liit));
                      fout<<"$ & \\cmtTopoTags{--- & }";
                      unsigned long nCCasesOfRest=0;
                      if(m_ccSwitch==true)
      ...
      for(unsigned int i=0;i<m_vSigDcyTr.size();i++)
        {
          if(i==0)
            {
              ...
              fout<<" & \\cmtTopoTags{iSigDcyTr & iSigDcyIFSts & }";
          ...
          fout<<"\\cmtTopoTags{"<<m_vISigDcyTr[i]<<" & ";
      ...
      for(unsigned int i=0;i<m_vSigDcyIFSts.size();i++)
        {
          if(i==0)
            {
              ...
              fout<<"\\tableheader{rowNo & \\thead{signal decay initial-final states} & \\cmtTopoTags{iSigDcyIFSts & }";
              if(m_compAnaOfDcyTrs==true||m_compAnaOfDcyIFSts==true) fout<<"iDcyIFSts & ";
              fout<<"nEtrs & ";
              if(m_ccSwitch==true) fout<<"nCcEtrs & nTotEtrs & ";
              fout<<"nCEtrs \\\\}"<<endl<<endl;
          ...
          fout<<"\\rightarrow ";
          for(liit++;liit!=sigDcyIFSts.end();liit++) writePnmFromPid(fout,"TexPnm",(*liit));
          fout<<"$ & \\cmtTopoTags{"<<m_vISigDcyIFSts[i]<<" & ";
          if(m_compAnaOfDcyTrs==true||m_compAnaOfDcyIFSts==true)
            {
      ...
      for(unsigned int i=0;i<m_vSigDcyIFSts2.size();i++)
        {
          if(i==0)
            {
              ...
              fout<<"\\tableheader{rowNo & \\thead{signal decay initial-final states} & \\cmtTopoTags{iSigDcyIFSts2 & }";
              if(m_compAnaOfDcyTrs==true||m_compAnaOfDcyIFSts==true) fout<<"iDcyIFSts & ";
              fout<<"nEtrs & ";
              if(m_ccSwitch==true) fout<<"nCcEtrs & nTotEtrs & ";
              fout<<"nCEtrs \\\\}"<<endl<<endl;
          ...
          fout<<"$ & \\cmtTopoTags{"<<m_vISigDcyIFSts2[i]<<" & ";
          if(m_compAnaOfDcyTrs==true||m_compAnaOfDcyIFSts==true)
            {
      ...
      for(unsigned int i=0;i<m_vNSigP.size();i++)
        {
          if(i==0)
            {
              ...
              fout<<"\\tableheader{rowNo & \\thead{signal particle} & \\cmtTopoTags{iSigP & }nPs & ";
          ...
          fout<<"$ & \\cmtTopoTags{"<<m_vISigP[i]<<" & }"<<m_vNSigP[i]<<" & ";
          if(m_ccSwitch==true)
            {
      ...
      for(unsigned int i=0;i<m_vSigDcyBr.size();i++)
        {
          if(i==0)
            {
              ...
              fout<<"\\tableheader{rowNo & \\thead{signal decay branch} & \\cmtTopoTags{iSigDcyBr & }nCases & ";
          ...
          fout<<"\\rightarrow ";
          for(liit++;liit!=sigDcyBr.end();liit++) writePnmFromPid(fout,"TexPnm",(*liit));
          fout<<"$ & \\cmtTopoTags{"<<m_vISigDcyBr[i]<<" & }"<<m_vNSigDcyBr[i]<<" & ";
          if(m_ccSwitch==true)
            {
      ...
      for(unsigned int i=0;i<m_vSigIncDcyBr.size();i++)
        {
          if(i==0)
            {
              ...
              fout<<"\\tableheader{rowNo & \\thead{signal inclusive decay branch} & \\cmtTopoTags{iSigIncDcyBr & }"<<"nCases & ";
              if(m_ccSwitch==true) fout<<"nCcCases & nTotCases & "<<endl;
              fout<<"nCCases \\\\}"<<endl<<endl;
            }
          fout<<"% \\rn = "<<i+1<<endl;
          ...
          fout<<" + \\rm{anything} $ & \\cmtTopoTags{"<<m_vISigIncDcyBr[i]<<" & }"<<m_vNSigIncDcyBr[i]<<" & ";
          if(m_ccSwitch==true)
            {
      ...
      for(unsigned int i=0;i<m_vSigCascDcyBrs.size();i++)
        {
          if(i==0)
            {
              ...
              fout<<"\\tableheader{rowNo & \\thead{signal cascade decay branches} & \\cmtTopoTags{iSigCascDcyBrs & }nCases & ";
              if(m_ccSwitch==true) fout<<"nCcCases & nTotCases & "<<endl;
              fout<<"nCCases \\\\}"<<endl<<endl;
            }
          sigCascDcyBrs.clear();
          ...
          fout<<" & \\cmtTopoTags{"<<m_vISigCascDcyBrs[i]<<" & }"<<m_vNSigCascDcyBrs[i]<<" & ";
          if(m_ccSwitch==true)
            {
      ...
      for(unsigned int i=0;i<m_vSigIncCascDcyBrs.size();i++)
        {
          if(i==0)
            {
              ...
              fout<<"\\tableheader{rowNo & \\thead{signal inclusive cascade decay branches} & \\cmtTopoTags{iSigIncCascDcyBrs & }nCases & ";
              if(m_ccSwitch==true) fout<<"nCcCases & nTotCases & "<<endl;
              fout<<"nCCases \\\\}"<<endl<<endl;
            }
          ...
          fout<<" & \\cmtTopoTags{"<<m_vISigIncCascDcyBrs[i]<<" & }"<<m_vNSigIncCascDcyBrs[i]<<" & ";
          if(m_ccSwitch==true)
            {
      ...
      for(unsigned int i=0;i<m_vSigIRADcyBr.size();i++)
        {
          if(i==0)
            {
              ...
              fout<<"\\tableheader{rowNo & \\thead{signal intermediate-resonance-allowed decay branch} & \\cmtTopoTags{iSigIRADcyBr & }nCases & ";
              if(m_ccSwitch==true) fout<<"nCcCases & nTotCases & "<<endl;
              fout<<"nCCases \\\\}"<<endl<<endl;
            }
          fout<<"% \\rn = "<<i+1<<endl;
          ...
          fout<<"$ & \\cmtTopoTags{"<<m_vISigIRADcyBr[i]<<" & }"<<m_vNSigIRADcyBr[i]<<" & ";
          if(m_ccSwitch==true)
            {
      ...
      for(unsigned int i=0;i<m_vSigIncOrIRACascDcyBrs.size();i++)
        {
          if(i==0)
            {
              ...
              fout<<"\\tableheader{rowNo & \\thead{signal inclusive or intermediate-resonance-allowed \\\\ cascade decay branches} & \\cmtTopoTags{iSigIncOrIRACascDcyBrs & }nCases & ";
              if(m_ccSwitch==true) fout<<"nCcCases & nTotCases & "<<endl;
              fout<<"nCCases \\\\}"<<endl<<endl;
            }
          ...
          fout<<" & \\cmtTopoTags{"<<m_vISigIncOrIRACascDcyBrs[i]<<" & }"<<m_vNSigIncOrIRACascDcyBrs[i]<<" & ";
          if(m_ccSwitch==true)
            {
